...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    old_db_id: Schema.Attribute.BigInteger;
    posts: Schema.Attribute.Relation<'manyToMany', 'api::post.post'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    thumb_nail: Schema.Attribute.Media<'images' | 'files'>;
...
export interface ApiEvaluateEvaluate extends Struct.SingleTypeSchema {
  collectionName: 'evaluates';
  info: {
    displayName: 'Evaluate';
    pluralName: 'evaluates';
    singularName: 'evaluate';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    home: Schema.Attribute.Component<'evaluate.home-gallery', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiGalleryGallery extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    home: Schema.Attribute.Component<'galley.home-gallery', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gallery.gallery'
    > &
      Schema.Attribute.Private;
    post: Schema.Attribute.Component<'galley.post-gallery', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text;
    email: Schema.Attribute.Email;
    hotline1: Schema.Attribute.String;
    hotline2: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateVenue: Schema.Attribute.DateTime;
    description: Schema.Attribute.Text;
    isFeatured: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    scale: Schema.Attribute.BigInteger;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::evaluate.evaluate': ApiEvaluateEvaluate;
